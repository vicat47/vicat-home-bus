...
| 类别 | 路径 | 文档数 | 状态 |
|------|------|--------|------|
| 规格说明 | `doc/specs/` | 9 | homebus.md + config-paradigm.md + event-types.md + routing-registry.md + backend-boundaries.md + sensitive-data.md + beancount-integration.md + database-schema.md + adapter-interfaces.md ✅ |
